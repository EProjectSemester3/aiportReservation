                ...
                <div className="col">
                  <div className="form-floating mb-3">
                    <input
                      ...
                      id="floatingInput"
                    />
                    <label htmlFor="floatingInput text-uppercase">DEPARTING</label>
                  </div>
                </div>
                <div className="col">
                  <div className="form-floating mb-3">
                    <input
                      ...
                      id="floatingInput"
                    />
                    <label htmlFor="floatingInput text-uppercase">RETURNING</label>
                  </div>
                </div>
              </div>
              <div className="row mb-4">
                ...
                <div className="col">
                  <div className="form-floating mb-3">
                    <input
                      ...
                      value="0"
                    />
                    <label htmlFor="floatingInput text-uppercase">BABY(0-2)</label>
                  </div>
                </div>
              </div>
              <div className="row">
